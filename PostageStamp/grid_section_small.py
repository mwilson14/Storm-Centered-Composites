...
def gridding_spin_fast(radar,radar_v,Z0C,tr1_lon,tr1_lat):
    print('Grid Section')
    ...
    grid = pyart.map.grid_from_radars(
    	(radar,),
    	grid_shape=(41, 150, 150),
    	grid_limits=((0, 10000), (-37500.0, 37500.0), (-37500.0, 37500.0)),
        grid_origin=(tr1_lat, tr1_lon),
